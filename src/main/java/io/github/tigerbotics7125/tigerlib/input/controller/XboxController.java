 ...
 * <p>
 * Saves RAM on the roborio by only instantiating a button when its used. CPU
 * time is cheaper than RAM in this scenario.
 *
...
public class XboxController extends GenericHID {
	...
	LEFT_X(0), LEFT_Y(1), LT(2), RT(3), RIGHT_X(4), RIGHT_Y(5);
	...
	A(1), B(2), X(3), Y(4), LB(5), RB(6), BACK(7), START(8), LEFT_STICK(9), RIGHT_STICK(10);
    ...
    /**
     * Builds a {@link JoystickTrigger} for this controller from the provided
     * {@link XboxButton}.
     *
    ...
    /**
     * Builds a {@link JoystickAxis} for this controller from the provided
     * {@link XboxAxis}.
     *
